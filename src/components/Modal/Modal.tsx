...
export function Modal() {
  ...
  const { handleWinnerHero, heroesBattle, setHeroesBattle } =
    ...
    <>
      {modalIsOpen === true ? (
        <div className="fixed inset-0 flex items-center justify-center z-50">
          ...
          <div className="max-w-[71.25rem] w-full h-[36.25rem] bg-black p-6 rounded-lg z-50 flex flex-col justify-center items-center gap-9 relative">
            <button
              onClick={handleModalIsOpen}
              className="absolute top-5 text-gray-200 right-5 cursor-pointer"
            >
              <X />
            </button>
